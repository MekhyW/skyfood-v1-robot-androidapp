...
.method public constructor <init>(Lorg/java_websocket/server/WebSocketServer;)V
    ...
    iput-object p1, p0, Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;->iqueue:Ljava/util/concurrent/BlockingQueue;
    ...
    invoke-virtual {p0, p1}, Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;->setName(Ljava/lang/String;)V

    .line 1010
    new-instance p1, Lorg/java_websocket/server/WebSocketServer$WebSocketWorker$1;

    invoke-direct {p1, p0}, Lorg/java_websocket/server/WebSocketServer$WebSocketWorker$1;-><init>(Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;)V

    invoke-virtual {p0, p1}, Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;->setUncaughtExceptionHandler(Ljava/lang/Thread$UncaughtExceptionHandler;)V

    return-void
.end method

.method static synthetic access$0(Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;)Lorg/java_websocket/server/WebSocketServer;
    .locals 0
...
.method private doDecode(Lorg/java_websocket/WebSocketImpl;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1, p2}, Lorg/java_websocket/server/WebSocketServer;->access$2(Lorg/java_websocket/server/WebSocketServer;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v0, p2}, Lorg/java_websocket/server/WebSocketServer;->access$2(Lorg/java_websocket/server/WebSocketServer;Ljava/nio/ByteBuffer;)V
...
.method public run()V
    ...
    invoke-static {v2, v1, v0}, Lorg/java_websocket/server/WebSocketServer;->access$1(Lorg/java_websocket/server/WebSocketServer;Lorg/java_websocket/WebSocket;Ljava/lang/Exception;)V
