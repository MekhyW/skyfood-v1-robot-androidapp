...
# direct methods
.method public static synthetic $r8$lambda$qb5LmhsTH7lXZ2b_YonFiJC4_cU(Ljava/io/File;)Ljava/lang/String;
    .locals 0
...
.method private getClassPath()Ljava/util/List;
    ...
    invoke-direct {v3}, Lcn/hutool/core/compiler/JavaSourceCompiler$$ExternalSyntheticLambda2;-><init>()V
...
.method private getJavaFileObject()Ljava/util/List;
    ...
    .line 247
    new-instance v3, Lcn/hutool/core/compiler/JavaSourceCompiler$$ExternalSyntheticLambda3;

    invoke-direct {v3, v0, v2}, Lcn/hutool/core/compiler/JavaSourceCompiler$$ExternalSyntheticLambda3;-><init>(Ljava/util/List;Ljava/io/File;)V
...
.method public compile()Ljava/lang/ClassLoader;
    ...
    .line 171
    invoke-virtual {p0, v0}, Lcn/hutool/core/compiler/JavaSourceCompiler;->compile(Ljava/util/List;)Ljava/lang/ClassLoader;
...
.method public compile(Ljava/util/List;)Ljava/lang/ClassLoader;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 198
    new-instance v1, Lcn/hutool/core/compiler/JavaSourceCompiler$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Lcn/hutool/core/compiler/JavaSourceCompiler$$ExternalSyntheticLambda0;-><init>()V

    const/4 v3, 0x1

    invoke-static {v0, v1, v3}, Lcn/hutool/core/collection/CollUtil;->map(Ljava/lang/Iterable;Ljava/util/function/Function;Z)Ljava/util/List;
    ...
    :goto_0
    invoke-static {v0, v1}, Lcn/hutool/core/collection/CollUtil;->join(Ljava/lang/Iterable;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    .line 206
    invoke-static {v2, v0, p1, v1}, Lcn/hutool/core/compiler/CompilerUtil;->getTask(Ljavax/tools/JavaFileManager;Ljavax/tools/DiagnosticListener;Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljavax/tools/JavaCompiler$CompilationTask;
    ...
    .line 210
    sget-object p1, Ljavax/tools/StandardLocation;->CLASS_OUTPUT:Ljavax/tools/StandardLocation;

    invoke-virtual {v2, p1}, Lcn/hutool/core/compiler/JavaClassFileManager;->getClassLoader(Ljavax/tools/JavaFileManager$Location;)Ljava/lang/ClassLoader;
    ...
    .line 216
    new-instance p1, Lcn/hutool/core/compiler/CompilerException;

    invoke-static {v0}, Lcn/hutool/core/compiler/DiagnosticUtil;->getMessages(Ljavax/tools/DiagnosticCollector;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p1, v0}, Lcn/hutool/core/compiler/CompilerException;-><init>(Ljava/lang/String;)V
